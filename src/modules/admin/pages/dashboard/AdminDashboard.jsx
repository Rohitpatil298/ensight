...
export default function AdminDashboard() {
  ...
  return (
    <Box sx={{ width: "100%", maxWidth: "1600px", mx: "auto" }}>
      ...
      <PageHeader
        title="Dashboard"
        subtitle="Monitor your healthcare analytics and survey statistics"
        actions={
          <>
            <Button
              variant="contained"
      ...
      >
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          <StatsCard
            ...
            label="Survey Completed by Doctors"
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          <StatsCard
            ...
            label="Remuneration Received by Doctors"
