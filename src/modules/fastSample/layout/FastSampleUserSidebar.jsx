...
export function FastSampleUserSidebar({ mobileOpen, onDrawerToggle }) {
  // FastSampleUserSidebar: render only a temporary drawer for mobile devices.
  ...
  const menuItems = [
    { path: "/users/survey", label: "Survey"},
