...
const SurveyPage = () => {
  ...
  // Handle survey click - navigate to practice type selection
  const handleSurveyClick = (doctor) => {
    navigate("/users/survey/take", { state: { doctor } });
  };

  const handleDocumentClick = (doctor) => {
    navigate("/users/survey/fmv", { state: { doctor } });
  };
  ...
  const doctorsData = [
    {
      ...
      email: "amartya.shankar@example.com",
      initials: "AS",
      title: "Test Survey 6",
      survey: "completed",
      document: "completed",
    ...
    },
    {
      ...
      email: "amartya.chowdhury@example.com",
      initials: "AC",
      title: "Test Survey 6",
      survey: "completed",
      document: "completed",
              ...
              <TableHead>
                ...
                >
                  {[
                    ...
                    { label: "Approval Agreement", align: "center" },
                  ].map((col) => (
                    <TableCell
                      key={col.label}
                      align={col.align}
                ...
                {filtered.length > 0 ? (
                  filtered.map((doc, idx) => (
                    ...
                    >
                      ...
                      {/* Invite by Link */}
                      <TableCell align="center" sx={{ py: 2.2 }}>
                        <Tooltip title="For Aggrement" arrow>
                          <Box
                            ...
                            onClick={() => {
                              navigate(`/users/sendlink?doctorId=${doc.id}`, {
                                state: { doctor: doc },
                              });
                            }}
                          >
                        ...
                        >
                          <Tooltip title="View Agreement" arrow>
                            <Box
                              ...
                              onClick={() => {
                                navigate(`/admin/cron/agreement-preview?doctorId=${doc.id}`, {
                                  state: { doctor: doc },
                                });
                              }}
                            >
                          ...
                          {doc.showAgreementActions ? (
                            <>
                              <Tooltip title="Approve Agreement" arrow>
                                <Box
                                  className="icon-btn-hover"
                                  sx={{
                                    ...agreementActionSx,
                              ...
                              <Tooltip title="Reject Agreement" arrow>
                                <Box
                                  className="icon-btn-hover"
                                  sx={{
                                    ...agreementActionSx,
                                ...
                                >
                                  <CloseIcon sx={{ color: "#E53935", fontSize: 16 }} />
                                </Box>
                              </Tooltip>
                            </>
                          ) : null}
